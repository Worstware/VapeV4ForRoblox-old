...
OldBedwarsAlt = GuiLibrary["ObjectsThatCanBeSaved"]["RenderWindow"]["Api"].CreateOptionsButton({
    ["Name"] = "OldBedwarsAlt",
    ["Function"] = function(callback)
        if callback then
...
Wintertheme = GuiLibrary["ObjectsThatCanBeSaved"]["RenderWindow"]["Api"].CreateOptionsButton({
    ["Name"] = "Wintertheme",
    ["Function"] = function(callback)
        if callback then
